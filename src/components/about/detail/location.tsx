function Location() {
  return (
    <div className=" container mx-auto h-full sm:block md:block lg:grid py-10 items-center md:py-20 lg:py-20 px-4  lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center  lg:py-14 ">
        <div className="order-2 pt-7 lg:pt-0 lg:pl-10">
          ...
          <button
            onClick={() => window.open("https://goo.gl/maps/aXLoCkQfyiUWSHFd9")}
            type="button"
